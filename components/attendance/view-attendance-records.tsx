...
export function ViewAttendanceRecords({ 
  ...
  }, [eventFilter, statusFilter, dateFrom, dateTo, selectedRegionFilter, selectedUniversityFilter, selectedSmallGroupFilter, selectedAlumniGroupFilter, regionId, universityId, smallGroupId, alumniGroupId]);
          ...
          <div className="flex flex-wrap gap-4 items-end">
            <div className="min-w-[180px]">
              ...
              <Select value={eventFilter} onValueChange={setEventFilter}>
                ...
                <SelectContent>
                  {/* Events would be passed as props */}
                </SelectContent>
              </Select>
            </div>
