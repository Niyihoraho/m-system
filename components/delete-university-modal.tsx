      ...
      <SheetContent side="top" className="h-auto w-full max-w-md mx-auto">
        <div className="py-8">
          <SheetHeader className="pb-6 text-center">
            ...
            <SheetTitle className="text-xl text-destructive">Delete University</SheetTitle>
            ...
            <div className="p-4 bg-destructive/5 border border-destructive/20 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-destructive">
                  ...
                  <p>This will permanently remove the university and all associated data from the system.</p>
                </div>
              </div>
            </div>
